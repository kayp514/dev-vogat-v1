...
export function PstnStatus({ className }: PstnStatusProps) {
  const { sipStatus, transportStatus, networkStatus } =
    useContext(SipProviderCtx);
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {transportStatus.charAt(0).toUpperCase() +
                      transportStatus.slice(1)}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="w-24">
